...
zip -rq "MYSIL-X-$DATE_VAR-$TIME_VAR-$VER_VAR.zip" "MYSIL-X-$DATE_VAR-$TIME_VAR-$VER_VAR"
tar -czf "MYSIL-X-$DATE_VAR-$TIME_VAR-$VER_VAR.tgz" "MYSIL-X-$DATE_VAR-$TIME_VAR-$VER_VAR"
#./Copy.bat
